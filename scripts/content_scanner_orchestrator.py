...
from Dublin_Core.content_scanner import EnhancedEarningsContentScanner
...
class SimpleDocumentProcessor:
    ...
    def process_document(self, filename: str, store_in_database: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            result["earnings_relevant"] = scan_result.is_earnings_relevant
    ...
    def _create_summary_report(self, result: Dict[str, Any], scan_result, metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "document_analysis": {
                "is_earnings_relevant": result["earnings_relevant"],
                "is_scb_document": result["scb_document"],
    ...
    def _print_summary(self, summary: Dict[str, Any]) -> None:
        ...
        # Analysis
        print(f"\n📋 Document Analysis:")
        print(f"   • Earnings Relevant: {'✅ YES' if analysis_info['is_earnings_relevant'] else '❌ NO'}")
